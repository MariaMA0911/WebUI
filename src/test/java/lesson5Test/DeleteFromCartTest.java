...
//static Logger logger = LoggerFactory.getLogger(AppTest.class);
    ...
    void DeleteFromCart (){
       ...
       //Assertions.assertTrue(getDriver().getTitle().contains("Аптека Будь Здоров – забронировать лекарства в аптеке и забрать самовывозом по низкой цене в Москва"), "страница входа недоступна");
